...
class NewPatient(Command):
    ...
    def process(self):
        ...
        try:
            ...
            case = models.Case(
                ref_id=self.form.clean.child.data, # probably comment this out
                last_name=self.form.clean.last_name.data
                first_name=self.form.clean.first_name.data
                provider=provider,
...
# Malawi version where ID is assigned to the child automatically
